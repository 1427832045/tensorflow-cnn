...
def identity_block(X_input):
    ...
    print(add_result)
    W_conv3 = weight_variable([1, 1, 256, 128])
...
X1 = identity_block(norma)
#X2 = identity_block(X1)
#X3 = identity_block(X2)
h_pool1 = max_pool_2x2(X1)
print(h_pool1)
...
h_conv4 = tf.nn.relu(conv2d1(h_pool1 , W_conv4) + b_conv4)
h_pool2 = max_pool_2x2(h_conv4)
normc = norm(h_pool2 , lsize=4)
print(normc)


#W_conv5 = weight_variable([3, 3, 128, 128])
#b_conv5 = bias_variable([128])
#h_conv5 = tf.nn.relu(conv2d1(normc , W_conv5) + b_conv5)
#normd = norm(h_conv5 , lsize=4)
#print(normd)


W_conv6 = weight_variable([1, 1, 128, 128])
b_conv6 = bias_variable([128])
h_conv6 = tf.nn.relu(conv2d1(normc , W_conv6) + b_conv6)
print(h_conv6)
...
#fc1
dense_tmp = tf.reshape(h_conv6, shape=[-1, 8*8*128])
print(dense_tmp)
