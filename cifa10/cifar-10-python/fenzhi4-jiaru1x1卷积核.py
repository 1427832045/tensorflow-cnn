...
X2 = identity_block(normb)

pool_2 = max_pool_2x2(X2)
print(pool_2)
...
print(h_conv3)
normc = norm(h_conv3 , lsize=4)

W_conv4 = weight_variable([5, 5, 128, 128])
b_conv4 = bias_variable([128])
h_conv4 = tf.nn.relu(conv2d1(normc, W_conv4) + b_conv4)
print(h_conv4)
normd = norm(h_conv4 , lsize=4)


W_conv5 = weight_variable([1, 1, 128, 64])
b_conv5 = bias_variable([64])
h_conv5 = tf.nn.relu(conv2d1(normd, W_conv5) + b_conv5)
print(h_conv5)


 
#fc1
dense_tmp = tf.reshape(h_conv5, shape=[-1, 8*8*64])
print(dense_tmp)
